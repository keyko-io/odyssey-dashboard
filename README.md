...
1. Based on query result, "Pass" or "Failed" response is returned to KLM (i.e. no source data is returned)
...
1. The Consigner, in this case *MSD*, gets a push notification that Customs is requesting additional information
